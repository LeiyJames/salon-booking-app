    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div v-for="stylist in store.locationStylists" :key="stylist.id" class="card p-5">
        <div class="flex items-start gap-4">
          <div class="w-14 h-14 rounded-2xl gradient-accent flex items-center justify-center text-white font-bold text-lg flex-shrink-0">
          ...
          <div class="flex-1 min-w-0">
            ...
            <div class="grid grid-cols-7 gap-1">
              ...
              >
                ...
                <div
                  class="rounded-lg py-1 text-[9px] font-medium"
                  :class="stylist.availability[day.key] ? 'bg-green-500/10 text-green-400' : 'bg-dark-700 text-dark-500'"
                >
