  ...
  <div class="min-h-screen pb-24 px-5">
    <div class="max-w-xl mx-auto pt-10">
      ...
      <div class="text-center mb-8 animate-scale-in">
        <div class="w-20 h-20 rounded-full bg-green-500/15 flex items-center justify-center mx-auto mb-4 animate-pulse-glow" style="--tw-shadow-color: rgba(0,200,83,0.15);">
      ...
      <div class="mt-6 space-y-3 animate-fade-in-up delay-300">
        ...
        <router-link to="/book" class="btn-secondary w-full">
